...
"User" is not limited to the end user of the app. It means whoever consumes the surface being designed:

- For UI / UX features: the human using the app.
